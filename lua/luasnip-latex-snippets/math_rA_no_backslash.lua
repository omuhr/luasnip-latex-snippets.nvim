...
local greek_postfix_completions = function()
  local re =
    "[aA]lpha|[bB]eta|[cC]hi|[dD]elta|[eE]psilon|[gG]amma|[iI]ota|[kK]appa|[lL]ambda|[mM]u|[nN]u|[oO]mega|[pP]hi|[pP]i|[rR]ho|[sS]igma|[tT]au|[tT]heta|[zZ]eta|[eE]ta|[xX]i"
...
local postfix_completions = function()
  local re =
    "sin|cos|tan|csc|sec|cot|ln|log|exp|star|perp|int|dif|lagrangian|hamiltonian|hodge|wedge|equiv|partial|pm|mp"
